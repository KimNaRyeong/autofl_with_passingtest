...
python compute_score.py \
    ...
    -l java -a -v -o combined_fl_results/d4j_gpt_0125_R1_full.json

python compute_score.py \
    results/d4j_autofl_1/gpt-3.5-turbo-0125 \
    results/d4j_autofl_2/gpt-3.5-turbo-0125 \
    -l java -a -v -o combined_fl_results/d4j_gpt_0125_R2_full.json

python compute_score.py \
    results/d4j_autofl_1/gpt-3.5-turbo-0125 \
    results/d4j_autofl_2/gpt-3.5-turbo-0125 \
    results/d4j_autofl_3/gpt-3.5-turbo-0125 \
    -l java -a -v -o combined_fl_results/d4j_gpt_0125_R3_full.json
...
python compute_score.py \
    ...
    -l java -a -v -o combined_fl_results/d4j_gpt_0125_R4_full.json
...
python compute_score.py \
    ...
    -l java -a -v -o combined_fl_results/d4j_gpt_0125_R5_full.json

# # Defects4J (AUTOFL-GPT-4)
# python compute_score.py \
#     results/d4j_autofl_1/gpt-4-0125 \
#     -l java -a -v -o combined_fl_results/d4j_gpt4_results_R1_full.json

# python compute_score.py \
#     results/d4j_autofl_1/gpt-4-0125 \
#     results/d4j_autofl_2/gpt-4-0125 \
#     -l java -a -v -o combined_fl_results/d4j_gpt4_results_R2_full.json

# # Defects4J (LLM-Test)
# python compute_score.py \
#     results/d4j_llmtest_1/gpt-3.5-turbo-0125 \
#     results/d4j_llmtest_2/gpt-3.5-turbo-0125 \
#     results/d4j_llmtest_3/gpt-3.5-turbo-0125 \
#     results/d4j_llmtest_4/gpt-3.5-turbo-0125 \
#     results/d4j_llmtest_5/gpt-3.5-turbo-0125 \
#     -l java -a -v -o combined_fl_results/d4j_llmtest_results_full.json

# # BugsInPy (AUTOFL-GPT-3.5)
# python compute_score.py \
#     results/bip_autofl_1/gpt-3.5-turbo-0125 \
#     -l python -a -v -o combined_fl_results/bip_gpt3_results_R1_full.json

# python compute_score.py \
#     results/bip_autofl_1/gpt-3.5-turbo-0125 \
#     results/bip_autofl_2/gpt-3.5-turbo-0125 \
#     -l python -a -v -o combined_fl_results/bip_gpt3_results_R2_full.json

# python compute_score.py \
#     results/bip_autofl_1/gpt-3.5-turbo-0125 \
#     results/bip_autofl_2/gpt-3.5-turbo-0125 \
#     results/bip_autofl_3/gpt-3.5-turbo-0125 \
...
#     results/bip_autofl_2/gpt-3.5-turbo-0125 \
#     results/bip_autofl_3/gpt-3.5-turbo-0125 \
#     results/bip_autofl_4/gpt-3.5-turbo-0125 \
...
#     results/bip_autofl_3/gpt-3.5-turbo-0125 \
#     results/bip_autofl_4/gpt-3.5-turbo-0125 \
#     results/bip_autofl_5/gpt-3.5-turbo-0125 \
#     -l python -a -v -o combined_fl_results/bip_gpt3_results_R5_full.json

# # BugsInPy (AUTOFL-GPT-4)
# python compute_score.py \
#     results/bip_autofl_1/gpt-4-0125 \
#     -l python -a -v -o combined_fl_results/bip_gpt4_results_R1_full.json

# python compute_score.py \
#     results/bip_autofl_1/gpt-4-0125 \
#     results/bip_autofl_2/gpt-4-0125 \
#     -l python -a -v -o combined_fl_results/bip_gpt4_results_R2_full.json

# # BugsInPy (LLM-Test)
# python compute_score.py \
#     results/bip_llmtest_1/gpt-3.5-turbo-0125 \
#     results/bip_llmtest_2/gpt-3.5-turbo-0125 \
#     results/bip_llmtest_3/gpt-3.5-turbo-0125 \
#     results/bip_llmtest_4/gpt-3.5-turbo-0125 \
#     results/bip_llmtest_5/gpt-3.5-turbo-0125 \
